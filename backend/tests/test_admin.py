...
def test_reset_users(client, admin_token, auth_header):
...
def test_reset_books(client, admin_token, auth_header):
    headers = auth_header(admin_token)
...
def test_reset_loans(client, admin_token, auth_header):
    headers = auth_header(admin_token)
...
def test_reset_requires_admin(client, auth_header, user_token):
    r = client.post("/api/admin/reset",
